...
public class PrincipalController {
	...
	public void acaoEvento(ActionEvent event) {
		...
		EventoController eventoController = new EventoController(txtCodigoEvento, txtNomeEvento, txtDataEvento,
				...
				txtCodigoIngresso, txtTipoIngresso, txtPrecoIngresso, taEvento);
		...
		else
		{
			if((cmd.contains("Excluir") && txtCodigoEvento.getText().isEmpty())){
				...
				try {
					...
					//	e.setData(txtDataEvento.getText()); //NAO SEI MEXER NISSO
						ev.setHora(Integer.parseInt(txtHoraEvento.getText()));
	...
	public void acaoCaravana(ActionEvent event) {
		...
		{
			if((cmd.contains("Excluir")) && txtCodigoCaravana.getText().isEmpty())
	...
	public void acaoCompra(ActionEvent event) {
		...
		CompraController compraController = new CompraController(txtCodigoCompra, txtNomeComprador, txtEmailCompra,
				txtCodigoEvento_compra, txtCodigoIngresso_compra, txtCodigoCaravana_compra,
				taCompra);
		
		if((cmd.contains("Salvar") || cmd.contains("Atualizar")) && (txtCodigoCompra.getText().isEmpty()))
